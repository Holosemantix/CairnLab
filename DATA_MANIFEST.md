...
- **Semantic margin pass-rate**: `assets/paper1_data/semantic_margin_passrate_lewm_three_seed.json` and `.md` (24 ok rows: training seeds 3072/3073/3074 × 4 tasks × {0.0, 0.08}; reports task-semantic pass rates plus same-state noisy radius and semantic-different rollout distance)
- **Validation remediation summary**: `assets/paper1_data/prospective_validation_summary.json` and `.md` (summarizes three-training-seed Gaussian behavior, development/held-out fixed-rule diagnostic validation, semantic margin pass-rate, and bounded unseen-stressor scope checks)
...
| `prospective_validation_summary.json` | Validation remediation summary, held-out diagnostic split, semantic pass-rate, and unseen scope check | `1cd1ef994ed1a58f0d243bd783026e312e80676912c3088ce09a1aa188f2d8b6` |
