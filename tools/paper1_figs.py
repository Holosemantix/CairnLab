...
# All numbers below are aggregated over 3 seeds × 100 eval trajectories
# (seeds 42/43/44, n=3 per cell); see canonical_evals_20260517.json.
EVAL_BASE = {
    "TwoRoom": {"clean": 94.00, "px08": 50.00},
    "PushT":   {"clean": 86.33, "px08":  4.67},
    "Reacher": {"clean": 58.67, "px08": 15.00},
    "Cube":    {"clean": 66.67, "px08": 46.33},
}
...
SWEEP = {
    "TwoRoom": {
        "clean":     [94.00, 93.67, 95.00, 96.33, 96.33, 96.00, 96.67, 96.00, 98.33],
        "px08":      [50.00, 87.67, 93.33, 94.67, 95.00, 95.67, 96.67, 96.33, 98.67],
        "clean_std": [ 3.56,  3.30,  2.83,  3.30,  2.05,  2.83,  2.05,  1.63,  0.47],
        "px08_std":  [ 1.41,  1.89,  0.94,  2.87,  2.45,  2.36,  2.49,  2.05,  0.94],
    },
    "PushT": {
        "clean":     [86.33, 88.00, 88.33, 89.67, 89.33, 80.67, 89.33, 85.67, 88.33],
        "px08":      [ 4.67, 43.33, 71.33, 83.00, 81.33, 75.00, 87.00, 82.33, 85.33],
        "clean_std": [ 2.36,  3.74,  2.62,  1.70,  2.05,  4.78,  2.05,  3.09,  2.87],
        "px08_std":  [ 2.05,  3.09,  3.68,  3.74,  2.87,  6.48,  3.74,  4.64,  2.62],
    },
    "Reacher": {
        "clean":     [58.67, 61.67, 85.67, 78.67, 84.00, 70.00, 86.00, 83.67, 84.00],
        "px08":      [15.00, 46.00, 85.67, 73.67, 80.00, 68.00, 84.67, 81.33, 83.00],
        "clean_std": [ 1.25,  2.49,  2.49,  1.25,  2.94,  2.16,  2.94,  3.30,  0.82],
        "px08_std":  [ 2.16,  1.63,  1.70,  0.47,  1.41,  3.56,  4.03,  1.25,  4.32],
    },
    "Cube": {
        "clean":     [66.67, 69.33, 60.00, 65.00, 69.00, 59.33, 66.67, 67.67, 62.33],
        "px08":      [46.33, 51.33, 60.67, 67.33, 67.00, 59.67, 65.00, 68.00, 60.33],
        "clean_std": [ 2.62,  0.47,  1.63,  1.63,  3.74,  0.94,  2.05,  0.94,  1.25],
        "px08_std":  [ 3.68,  5.79,  0.47,  1.89,  3.56,  2.05,  2.94,  1.41,  0.94],
    },
}
