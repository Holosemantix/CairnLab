...
| 脚本 | 作用 | 输入 | 输出 / 用途 |
|---|---|---|---|
| `tools/paper1_figs.py` | 渲染主文 6 张图 | `assets/paper1_data/canonical_evals_20260517.json`, `assets/paper1_data/canonical_diagnostics_20260517.json` | `assets/paper1_figs/fig1_hero.png` 到 `fig6_mechanism.png`，对应 `paper1/main.tex` Figures 1--6 |
