...
- **Selector plateau audit**: `assets/paper1_data/selector_plateau_audit_20260704.json` and `.md` (same 96 nonzero LeWM rows; treats `std_max` as a candidate label inside each task-training-seed block; reports best-5pp plateau hit, regret-to-plateau, and decisive-pair concordance rather than point-best std prediction)
...
| `selector_plateau_audit_20260704.json` | Plateau-aware selector audit with best-5pp and decisive-pair metrics | `543170328170dbbaf906132534dc70467fc13320d65b5ee38646b0492771d268` |
| `selector_plateau_audit_20260704.md` | Human-readable plateau-aware selector audit summary | `b88c6c679c714b0e4367bfb8d348cd477629f8ebdb0e67195be2771eb7a6faf7` |
...
| `selector_incremental_audit_20260704.md` | Human-readable legacy incremental selector/readout audit summary | `e8d18f895e95d8e4f8824bdb50c0f552f862a1123a783b53d2f938553ff44f71` |
...
- `selector_plateau_audit_20260704.json` stores the paper-facing plateau audit for the same 96 nonzero LeWM rows. It treats `std_max` as a candidate label inside each task-training-seed block, defines a best-5pp practical plateau, reports regret-to-plateau, and evaluates decisive-pair concordance only on checkpoint pairs whose closed-loop scores differ by more than 5pp.
