...
\caption{Qualitative PushT ACPC neighborhood t-SNE visualization for the origin LeWM versus \stdmax{} $=0.08$ noise-trained contrast. The four panels show encoder features and post-predictor rollout features for repeated same-state perturbation views; colored clusters mark fixed random anchors. The t-SNE projection is qualitative. ATR and SMPR are the quantitative diagnostics and are computed in the original projected-rollout diagnostic space.}
