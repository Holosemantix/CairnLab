...
3. The acknowledgement should point to the intended public code/data URL. A branch URL is acceptable for a draft, but a tag or release archive is preferable for a stable arXiv version.
