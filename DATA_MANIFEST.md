...
- **Unseen Phase-0 ACPC subset artifact**: `assets/paper1_data/unseen_phase0_acpc_subset.json` (matched diagnostic review artifact: 12 selected seed/task/stress case rows for training seeds 3072/3073/3074 joining 24 clean-goal Phase-0 diagnostic rows with strongest-only unseen eval scores)
...
| `prospective_validation_summary.json` | Validation remediation summary, fixed-rule diagnostic split, task-state proxy margin pass-rate, and unseen scope check | `124f7a2e8ed1b50000cb03a3064e8e68851378d53ea96edb386dcafb70c41f90` |
