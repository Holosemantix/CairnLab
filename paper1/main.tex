...
The table strengthens the interpretation of $R_F$ as a control-facing localization signal: on all four LeWM tasks, smaller paired rollout disagreement is accompanied by lower candidate-cost drift, higher candidate-ranking agreement, and fewer high-margin action flips. This is the empirical counterpart of the fixed-candidate stability statement: PCC measures candidate-cost drift, CRA measures ranking stability, and MAF is the margin-conditioned action-flip readout after high-margin filtering. Together with \Cref{tab:three-seed-diagnostic-split,tab:three-seed-diagnostic-validation}, these rollout/cost readouts provide triage signal beyond encoder radius while still leaving closed-loop evaluation as the final authority.
