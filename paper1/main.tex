...
The complete code and data for this revision are available at \url{https://github.com/Holosemantix/le-wm/tree/ag/dev}; JSON artifact hashes are listed in the data manifest. We thank the LeWM authors for releasing the baseline framework on which this study builds.
