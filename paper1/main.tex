...
\paragraph{Reading.} The audit evaluates membership enrichment, not point-optimal ranking. The aggregate screen is useful, but not uniquely dominant: MAF-only and the high-std reference are competitive. The high-std reference is a coarse intervention-order screen: larger noise often helps before plateau entry, but \stdmax{} is not a monotone ranker inside a plateau. We therefore read the screen as diagnostic enrichment and failure localization; closed-loop evaluation remains the authority.
